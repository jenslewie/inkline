"""Unit tests for EPUB table rendering."""

from __future__ import annotations

from inkline.epub.table.html import apply_cell_alignments, render_table_html
...
def test_apply_cell_alignments_none() -> None:
    ...
    result = apply_cell_alignments(html, None)
    assert result == html
...
def test_apply_cell_alignments_empty() -> None:
    ...
    html = "<table><tr><td>A</td></tr></table>"
    result = apply_cell_alignments(html, {})
    assert result == html
...
def test_apply_cell_alignments_default() -> None:
    ...
    result = apply_cell_alignments(html, {"default": "center"})
...
def test_apply_cell_alignments_row() -> None:
    ...
    result = apply_cell_alignments(html, {"rows": [[0, "right"]]})
...
def test_apply_cell_alignments_cell() -> None:
    ...
    html = "<table><tr><td>A</td><td>B</td></tr></table>"
    result = apply_cell_alignments(html, {"default": "center", "cells": [[0, 1, "right"]]})
...
def test_apply_cell_alignments_no_default_no_rows_no_cells() -> None:
    ...
    html = "<table><tr><td>A</td></tr></table>"
    result = apply_cell_alignments(html, {"default": ""})
...
def test_apply_cell_alignments_whitelist_ignores_invalid() -> None:
    ...
    result = apply_cell_alignments(html, {"default": 'center" onclick="x'})
    assert "td-align" not in result
    assert "onclick" not in result
    # Arbitrary string also ignored
    result2 = apply_cell_alignments(html, {"default": "justify"})
