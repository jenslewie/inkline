...
def page_review_llm_prompt(input_data: dict[str, Any]) -> str:
    return (
        ...
        "text_flow_page, visual_page, table_or_chart_page, blank_page, unknown.\n"
        ...
        "Action rules:\n"
        "- page_role=text_flow_page: an ordinary reading-flow page, including a page that has "
        "body text plus an illustration or a structured table.\n"
