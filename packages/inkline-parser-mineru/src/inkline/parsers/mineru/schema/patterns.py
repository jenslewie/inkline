"""Regex patterns for text classification. Defines TOC_LINE_RE, CHAPTER_RE, PART_RE, ATTR_RE (attribution line), and CHINESE_RE. Used by page processing and reconciliation passes for structural text matching."""
